...
def step_impl(context):
    addActivity(context, 'Grow Spaghetti', 'Dig a hole')
...
def addActivity(context, process_name, activity_description):
    context.browser.find_element_by_name('process').send_keys(process_name)
