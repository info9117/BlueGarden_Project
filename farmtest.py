...
class BlueGardenFarmTests(TestCase):
    ...
    def test_start_process(self):
        ...
        response = self.start_process("crop", '', '', 1, "10 May, 2016", user.id, 1, '')
        self.assertIn(b"for your crop", response.data)
        print('\n## Test-- Dates not in May ##')
        response = self.start_process("crop", '', '', 1, "10 June, 2016", user.id, 1, '')
        self.assertIn(b"10 June, 2016", response.data)
